...
export default function ArenaChampion({ data, token, onFinish }) {
  ...
  return (
    <div style={{ textAlign: "center", paddingTop: 20, animation: "fadeIn 0.3s ease" }}>
      ...
      {isChamp ? (
        <>
          <div style={{ fontSize: "min(90px, 20vw)", marginBottom: 8, animation: "pulse 1.5s infinite" }}>🏆</div>
          <h1 style={{ fontSize: 32, fontWeight: 900, background: `linear-gradient(135deg, ${C.gold}, ${C.orange})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>بطل الحلبة!</h1>
        </>
      ) : (
        <>
